...
--
-- Host: localhost    Database: controle_atendimento
-- ------------------------------------------------------
...
--
-- Table structure for table `senhas_emitidas`
--

DROP TABLE IF EXISTS `senhas_emitidas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `senhas_emitidas` (
...
-- Dump completed on 2023-10-06 10:29:57
